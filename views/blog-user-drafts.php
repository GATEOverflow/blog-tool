<?php
    ...
    list( $useraccount, $userpoints, $posts ) = qa_db_select_with_pending(
        ...
        qas_blog_db_user_recent_drafts_selectspec( $loginuserid, $identifier, qa_opt_if_loaded( 'qas_blog_page_size_ps' ), $start )
    );
    ...
    $count = (int) qas_blog_db_user_recent_drafts_count( $identifier );
...
//	Prepare content for theme
    ...
    if ( count( $posts ) )
        $qa_content[ 'title' ] = qa_lang_html_sub( 'qas_blog/drafts_by_x', $userhtml );
    else
        $qa_content[ 'title' ] = qa_lang_html_sub( 'qas_blog/no_drafts_by_x', $userhtml );
